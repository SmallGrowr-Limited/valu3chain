  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => router.push("/ecosystem/home/aiQuery")}
      >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.actionsContainer}>
          <TouchableOpacity
            ...
            onPress={() => router.push("/ecosystem/home/purchaseOrder")}
          >
        ...
        <View style={styles.actionsContainer}>
          <TouchableOpacity
            style={styles.actionButton}
            onPress={() => router.push("/ecosystem/home/returns")}
          >
      ...
      <View style={styles.section}>
        ...
        {portfolioData.recentOpportunities.map((opportunity) => (
          <InvestmentCard key={opportunity.id} data={opportunity} />
        ))}
      </View>
    </ScrollView>
  );
