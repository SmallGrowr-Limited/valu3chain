...
const FarmProduceAggregation = () => {
  ...
  const handleQuantityChange = (id, farmerId, field, value) => {
    const updatedProducts = selectedProducts.map((product) => {
      if (product.id === id && product.farmerId === farmerId) {
        ...
        if (field === "quantityAvailable") {
          const baseValue = quantity * product.currentMarketPrice;
          // Apply 2% increase if delivery is selected
          update.totalValue =
 ...
 const handleDeliveryOptionChange = (id, farmerId, option) => {
   const updatedProducts = selectedProducts.map((product) => {
     if (product.id === id && product.farmerId === farmerId) {
       ...
       // Recalculate total value with delivery fee if needed
       if (option === "delivery") {
         updatedProduct.totalValue =
           product.quantityAvailable * product.currentMarketPrice * 1.02;
       } else {
         updatedProduct.totalValue =
           product.quantityAvailable * product.currentMarketPrice;
       }
  ...
  const handleDateChange = (event, selectedDate, id, dateType) => {
  ...
  const showDatepicker = (id, dateType) => {
  ...
  return (
    <ScrollView style={styles.container}>
              ...
              >
                ...
                <View style={styles.productDetails}>
                  ...
                  <View style={styles.deliveryOptionsContainer}>
                    <Text style={styles.deliveryOptionsLabel}>
                      Collection Method:
                    </Text>
                  ...
                  <View style={styles.dateSelectionContainer}>
                    <Text style={styles.dateSelectionLabel}>
                      {product.deliveryOption === "delivery"
                        ? "Delivery Date:"
                        : "Pickup Date:"}
                    </Text>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>
              ...
              {selectedProducts
                .filter(
                  (p) =>
                    p.id === selectedCrop.id && p.deliveryOption === "delivery"
                )
                .reduce(
                  (sum, product) =>
                    sum +
      ...
      >
        <Text style={styles.submitButtonText}>Submit Aggregation</Text>
        <FontAwesome
          name="save"
          size={20}
          color="#fff"
